namespace FluentApiDemo
{
    public class AddressLabelBuilder : 
        INewAddress, 
        IBuildingNameSelection,
        IFloorNumberSelection,
        ...
        ICompleteAddress
    {
        ...
        public IBuildingNameSelection ForOfficeRecipient(string recipient)
        {
            _recipient = recipient;
            return this;
        }

        public IFloorNumberSelection InBuilding(string buildingName)
        {
            _buildingName = buildingName;
            return this;
        }

        public IStreetAddressSelection OnFloor(int floorNumber)
        {
        ...
        public AddressLabel Build(Action<PrintingConfiguration> printingConfig)
        {
            var newAddress = Build();
            printingConfig?.Invoke(newAddress.PrintingConfiguration);
